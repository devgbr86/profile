...
- **TailwindCSS**  
  Framework CSS utilitário que permite estilizar elementos diretamente via classes, sem a necessidade de escrever CSS complexo.  
  Facilita a criação de layouts responsivos, limpos e modernos, mantendo alta consistência visual em todo o site.
